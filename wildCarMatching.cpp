...
bool match(char *first, char * second)
{
    ...
    if (*first == '\0' && *second == '\0')
        return true;
    /*
    Note - this is not correct condtion to handle case first = "*", second = "" or any first string ending with '*'
    if we want to put below condition then it should be , we should put this check first
