 ...
 **************************************************************************
 *Question :
 * Find the largest substring within a text that is repeated at least twice. 
 *    So for "hello, mr. yellow", the function should return "ello".
 *
 * Solution :
 * 1) get list of all suffixes of string  ( str[] )
 * 2) sort the arr
 * 3) compare adjacent strings to find longest matching prefix
 * 4) return the longest match
 *************************************************************************/

//Reference : http://introcs.cs.princeton.edu/java/42sort/LRS.java.html
